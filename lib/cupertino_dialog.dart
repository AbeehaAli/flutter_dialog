...
import 'package:flutter_appbar/cupertino_bottomsheet.dart';

class cuppertinoDialog extends StatefulWidget {
  const cuppertinoDialog({super.key});

  @override
  State<cuppertinoDialog> createState() => __cuppertinoDialoguStateState();
}

class __cuppertinoDialoguStateState extends State<cuppertinoDialog> {
  int currentindex =0;
        ...
        children: [
          SizedBox(
            ...
            child: Row(
              ...
              children: [
                CupertinoButton(child: const Text("Done"),
  ...
  DateTime temp =DateTime(2025,1,1,
  selectedTime.hour,
  selectedTime.minute,
  );
               ...
               Padding(
                 ...
                 child: Container(
                  ...
                  child: ElevatedButton.icon(onPressed: () {
                    showCupertinoSheet(context: context,
                     builder: (context) => SafeArea(child: 
                     Material(
